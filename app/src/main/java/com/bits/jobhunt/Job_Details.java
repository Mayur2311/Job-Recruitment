...
public class Job_Details extends AppCompatActivity {
    ...
    public void insertAppliedData(String jobtitle, String company_name, String company_location, String salary, String jobtype, String vacancy, String qualification, String description, String userid) {
        ...
        db.collection("AppliedJob").document(fuser).collection("jobs_applied").document().set(profileData)
    ...
    public void insertSavedData(String jobtitle, String company_name, String company_location, String salary, String jobtype, String vacancy, String qualification, String description) {
        ...
        db.collection("SavedJob").document(fuser).collection("jobs_saved").document().set(profileData)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
